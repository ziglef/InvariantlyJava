...
public class EqualsVisitor implements GenericVisitor<Boolean, Node> {
	...
	@Override
	public Boolean visit(SuperMemberAccessExpr n1, Node arg) {
		SuperMemberAccessExpr n2 = (SuperMemberAccessExpr) arg;
		
		if(n1.getBeginColumn() != n2.getBeginColumn()){
			return Boolean.FALSE;
		}
		...
		if(n1.getEndColumn() != n2.getEndColumn()){
			return Boolean.FALSE;
		}
